...
const ComposeMail = (props) => {
  ...
  const onSubmitHandler = (event) => {
    ...
    if (
      enteredFromEmail.trim().length === 0 ||
      enteredToEmail.trim().length === 0 ||
      enteredSubjectEmail.trim().length === 0 ||
    ...
    <div className="p-3 bg-light text-dark">
      <Form onSubmit={onSubmitHandler}>
        ...
        <div className="mb-3">
          ...
          <Button variant="primary" href="/welcome" style={{ float: "right" }}>
            Back
          </Button>
        </div>
      </Form>
